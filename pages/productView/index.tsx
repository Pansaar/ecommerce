        ...
        <div>
            ...
            {isLoading ?
                ...
                <div style={{paddingBottom: '60px'}}>
                    ...
                    <div style={{ position: 'relative', width: '25%', height: '100%', backgroundColor: '#FFFDD0', display: 'flex', justifyContent: 'center', alignItems: 'center' }} onClick={() => console.log('Add to Shopping Cart')}>
                    ...
                    <div style={{ position: 'relative', width: '50%', height: '100%', backgroundColor: '#800020', display: 'flex', justifyContent: 'center', alignItems: 'center' }} onClick={() => console.log('Purchase')}>
