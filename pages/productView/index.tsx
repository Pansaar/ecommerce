        ...
        <div>
            ...
            {isLoading ? (
                ...
                <div style={{paddingBottom: '60px'}}>
                    ...
                    <div id='prodAmount' style={{ display: 'flex', position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'white', width: '300px', height: '200px', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', boxShadow: '2px 2px 20px grey', textAlign: 'center', padding: '20px' }}>
