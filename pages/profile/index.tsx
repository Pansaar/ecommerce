...
const index = () => {
  ...
  return (
    <div>
      <TopNav1 />
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={20} fill='white' style={{position: 'fixed', top: '15px', right: '70px', zIndex: '2', cursor: 'pointer'}}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={20} fill='white' style={{position: 'fixed', top: '15px', right: '30px', zIndex: '2', cursor: 'pointer'}}>
