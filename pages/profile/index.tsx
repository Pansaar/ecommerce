...
const index = () => {
  ...
  const fetchProfilePic = async () => {
    try {
      const response = await fetch('/api/fetchProfilePic');
      if (response.ok) {
  ...
  return (
    <div>
      ...
      <div className='mt-3' onClick={toEditProfilePic} style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "130px", height: "130px", borderRadius: "50%", marginLeft: '80px', backgroundColor: 'lightgrey', cursor: 'pointer' }}>
          {isProfile ? <img src={profilePic} style={{ justifyContent: "center", alignItems: "center", width: "130px", height: "130px", borderRadius: "50%", backgroundColor: 'lightgrey', cursor: 'pointer' }}></img>:<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={70} fill='white'>
