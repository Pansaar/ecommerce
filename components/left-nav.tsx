...
const LeftNav = () => {
  ...
  return (
    <nav style={{
      position: 'fixed',
      left: showNav ? '0' : '-170px',  // Adjust the width of the leftnav
      top: '0',
      height: '100vh',
      width: '170px',
      ...
      <ul className='vh-100' style={{ overflowY: 'hidden', listStyle: 'none', margin: '0', padding: '0' }}>
        <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }}>Profile</li>
        <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }}>Shopping Cart</li>
        <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }}>MyMerchant</li>
        <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }} onClick={() => useRouter().replace('/')}>Log out</li>
      </ul>
    </nav>
  );
};
