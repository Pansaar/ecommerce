...
const LeftNav = () => {
  ...
  return (
    <nav style={{
      ...
      <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }} onClick={() => {{router.push(`/home?user=${encodeURIComponent(authenticatedUser)}`, undefined, { shallow: true }), setShowNav(false)}}}>Home</li>
        <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }} onClick={() => {{router.push(`/profile?user=${encodeURIComponent(authenticatedUser)}`, undefined, { shallow: true }), setShowNav(false)}}}>Profile</li>
        <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }} onClick={() => {{router.push(`/shoppingCart?user=${encodeURIComponent(authenticatedUser)}`, undefined, { shallow: true }), setShowNav(false)}}}>Shopping Cart</li>
        <li style={{ marginTop: '30px', marginLeft: '30px', cursor: 'pointer' }} onClick={() => {{router.push(`/myMerchant?user=${encodeURIComponent(authenticatedUser)}`, undefined, { shallow: true }), setShowNav(false)}}}>MyMerchant</li>
